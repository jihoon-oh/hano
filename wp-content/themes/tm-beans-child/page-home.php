...
<?php
/*
THIS FUNCTION IS MADE TO LOAD THE CONTENT FROM WP-ADMIN
beans_load_document();
*/
?>
      ...
      <ul class="thumbnails list-unstyled">
        ...
        <li class="col-md-3">
          <div class="thumbnail" style="padding: 0">
            ...
            <div class="modal-footer" style="text-align: left">
              <div class="progress">
                <div class="progress-bar bar-success" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 100%;">
                    <span class="sr-only">60% Complete</span>
                </div>
              </div>
              <div class="row">
